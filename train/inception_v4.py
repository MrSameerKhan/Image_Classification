...
# TRAINING_IMAGES_DIR = os.getcwd() + '/dataSet/training_images'
TRAINING_IMAGES_DIR = "training_data"


# TEST_IMAGES_DIR = os.getcwd() + "/dataSet/test_images/"
TEST_IMAGES_DIR = "test_data"

# where to save the trained graph
OUTPUT_GRAPH = os.getcwd() + '/checkPoints/' + 'retrained_graph.pb'

# where to save the intermediate graphs
INTERMEDIATE_OUTPUT_GRAPHS_DIR = os.getcwd() + "/checkPoints/intermediate/"+'intermediate_graph'

# how many steps to store intermediate graph, if "0" then will not store
INTERMEDIATE_STORE_FREQUENCY = 0

# where to save the trained graph's labels
OUTPUT_LABELS = os.getcwd() + '/checkPoints/' + 'retrained_labels.txt'

# where to save summary logs for TensorBoard
TENSORBOARD_DIR = os.getcwd() + '/logs/' + 'tensorboard_logs'
...
BOTTLENECK_DIR = os.getcwd() + '/logs/' + 'bottleneck_data'
