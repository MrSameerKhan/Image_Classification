...
RETRAINED_LABELS_TXT_FILE_LOC = os.getcwd() + "/checkPoints/" + "retrained_labels.txt"
RETRAINED_GRAPH_PB_FILE_LOC = os.getcwd() + "/checkPoints/" + "retrained_graph.pb"
#RETRAINED_LABELS_TXT_FILE_LOC = "/home/zyclyx/Documents/Branch_Development/Inception_V4_ClassificationCode/train" + "/" + "retrained_labels.txt"
#RETRAINED_GRAPH_PB_FILE_LOC = "/home/zyclyx/Documents/Branch_Development/Inception_V4_ClassificationCode/train" + "/" + "retrained_graph.pb"


TEST_IMAGES_DIR = os.getcwd() + "/test_data"
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for fileName in os.listdir(TEST_IMAGES_DIR):
            ...
            #if not (fileName.lower().endswith(".jpg") or fileName.lower().endswith(".jpeg") or fileName.lower().endswith(".tif")):
            ...
            for prediction in sortedPredictions:
                ...
                if onMostLikelyPrediction:
                    ...
                    if not os.path.exists(path):
                        os.makedirs(path)
                    cv2.imwrite('result/'+str(i)+'.tif', openCVImage)
                    i=i+1
